...
class doubleBattleEnv(fc.FPSEnv):
    ...
    def _voice_check(self,):
        ...
        def plan(s):
            idx = int(s[2:])
            team_num = [[0,2,2,2,2,2], [0,2,5,1,1,1], [0,0,3,3,2,2], [0,0,1,2,5,2],
                        [0,1,4,2,2,1], [0,3,3,1,2,1], [0,1,4,3,0,2], [0,2,1,5,1,1],
                        [0,1,3,5,1,0], [0,2,4,0,4,0], [0,1,4,2,1,2], [0,1,3,2,2,2]][idx]
            area_id = 1
            objid_list = []
